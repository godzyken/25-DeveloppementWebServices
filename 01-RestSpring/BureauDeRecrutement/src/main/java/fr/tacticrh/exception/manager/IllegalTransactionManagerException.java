...
public class IllegalTransactionManagerException extends IllegalTransactionException {
	 ...
	 */
	public IllegalTransactionManagerException () { super(); }
	 ...
	 */
	public IllegalTransactionManagerException (String pMessage) { super(pMessage); }
