...
public class IllegalTransactionPersonneException extends IllegalTransactionException {
	 ...
	 */
	public IllegalTransactionPersonneException () { super(); }
	 ...
	 */
	public IllegalTransactionPersonneException (String pMessage) { super(pMessage); }
