...
public class RecordNotFoundCurriculumException extends RecordNotFoundException {
	 ...
	 */
	public RecordNotFoundCurriculumException () { super(); }
	 ...
	 */
	public RecordNotFoundCurriculumException (String pMessage) { super(pMessage); }
